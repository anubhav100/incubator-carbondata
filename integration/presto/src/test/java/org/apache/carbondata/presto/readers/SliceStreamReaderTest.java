...
public class SliceStreamReaderTest {
  ...
  @Test public void testReadBlockWithVectorReaderAndDict() throws IOException {
    ...
    sliceStreamReader = new SliceStreamReader(true, new ColumnDictionaryInfo(DataType.DOUBLE));
  ...
  @Test public void testReadBlockWithOutVectorReaderAndWithOutDict() throws IOException {
    StructField structField = new StructField("column1", StringType, false, null);
    columnVector = ColumnVector.allocate(5, structField.dataType(), MemoryMode.ON_HEAP);
    columnVector.putByteArray(1, "string1".getBytes());
    columnVector.putByteArray(2, "string2".getBytes());
    ...
    sliceStreamReader = new SliceStreamReader(false, new ColumnDictionaryInfo(DataType.DOUBLE));
    sliceStreamReader.setBatchSize(5);
