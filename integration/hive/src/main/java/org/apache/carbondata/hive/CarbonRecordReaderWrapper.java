...
//
///**
// * Created by simar on 17/7/17.
// */
//public class CarbonRecordReaderWrapper implements RecordReader<Void, ArrayWritable> {
//
//    public static final Log LOG = LogFactory.getLog(CarbonRecordReaderWrapper.class);
//
...
//
//    public CarbonRecordReaderWrapper(
//            final CarbonInputFormat<ArrayWritable> newInputFormat,
...
//
//        jobConf = oldJobConf;
//        final CarbonInputSplit split = getSplit(oldSplit, jobConf);
//
...
//    protected CarbonInputSplit getSplit(
//            final InputSplit oldSplit,
//            final JobConf conf
//    ) throws IOException {
...
//                skipTimestampConversion = !Strings.nullToEmpty(fileMetaData.getCreatedBy()).startsWith("Carbon-mr");
//            }
//            split = new CarbonInputSplit(finalPath,
//                    splitStart,
//                    splitLength,
